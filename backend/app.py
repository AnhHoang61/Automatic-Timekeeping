...
#         reps = DeepFace.represent(
#             img_path=temp_path,
#             model_name="Facenet512",    # trùng với model lúc bạn enroll
...
#
#     # 4. Lấy danh sách embedding của tất cả nhân viên đã đăng ký
#     rows = fetch_all(
...
#
#     # 5. So sánh khoảng cách với từng embedding
#     best_employee = None
#     best_distance = 1.0  # khoảng cách cosine nằm trong [0,1]
#
#     for row in rows:
#         try:
...
#             best_employee = row
#
#     # 6. Đặt ngưỡng nhận diện
#     THRESHOLD = 0.4  # càng nhỏ càng chặt (0.4 ~ khá chặt cho Facenet512)
#
#     os.remove(temp_path)
#
#     if best_employee is None:
#         return jsonify({"matched": False, "message": "No valid embeddings"}), 400
#
#     if best_distance > THRESHOLD:
#         # khuôn mặt không đủ giống với bất kỳ ai
#         return jsonify({
#             "matched": False,
...
#         }), 200
#
#     # 7. Thành công: trả về thông tin nhân viên
#     return jsonify({
#         "matched": True,
